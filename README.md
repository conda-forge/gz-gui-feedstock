...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-gui-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-gui-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `gz-gui, gz-gui8, libgz-gui, libgz-gui8` can be installed with `conda`:

```
conda install gz-gui gz-gui8 libgz-gui libgz-gui8
```

or with `mamba`:

```
mamba install gz-gui gz-gui8 libgz-gui libgz-gui8
```
