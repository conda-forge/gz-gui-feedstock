...
Once the `conda-forge` channel has been enabled, `gz-gui, libgz-gui` can be installed with `conda`:

```
conda install gz-gui libgz-gui
```

or with `mamba`:

```
mamba install gz-gui libgz-gui
```
